...
-- 1. CONSULTA CON PARÁMETRO IN Y SUBCONSULTA IN
DELIMITER //
...
-- 4. CONSULTA CON PARÁMETRO INOUT
DELIMITER //
...
BEGIN
    ...
    SET p_acumulado = p_acumulado + v_conteo;
END //
DELIMITER ;

-- 5. CONSULTA OPTIMIZADA (Sustituye subconsultas innecesarias)
DELIMITER //
